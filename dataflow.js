...
exports.define = function (type, definition) {
	function brick() {
		...
		var self = this;
		brick.prototype.outputs.forEach(function (element) {
			self.outputs[element] = [];
		});

		Object.keys(brick.prototype.properties).forEach(function (key) {
			self[key] = brick.prototype.properties[key];
		});
	}
	...
	brick.prototype.inputs = definition.inputs || {};
	brick.prototype.outputs = definition.outputs || [];
	brick.prototype.properties = definition.properties || {};
};
