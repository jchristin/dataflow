...
exports.define = function(definition) {
	function NewBrick(props) {
		...
		NewBrick.prototype.inputs.forEach(function(element) {
			self.inputs[element] = new port.InputPort(function() {
				needProcessing = true;
	...
	// Add private methods.
	_.forEach(_.omit(definition, ["process", "inputs", "outputs", "props"]), function(value, key) {
		NewBrick.prototype[key] = value;
	});
